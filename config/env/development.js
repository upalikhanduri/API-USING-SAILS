...
module.exports = {
  ...
  security: {
    ...
    ***************************************************************************/
    cors: {
      ...
      // headers: 'Content-Type, Authorization, token,user_id,userId ,appType'
    },
  ...
  ***************************************************************************/
  sockets: {
    ...
    /***************************************************************************
    *                                                                          *
    * Uncomment the `onlyAllowOrigins` whitelist below to contedflutter@tedflutter-Latitude-E6430:~/Desktop/form$ npm start your app.        *
    * > Be sure to use the right protocol!  ("http://" vs. "https://")         *
    *                                                                          *
    ***************************************************************************/
    // onlyAllowOrigins: [
    ...
    // ],tedflutter@tedflutter-Latitude-E6430:~/Desktop/form$ npm startout a Redis  *
